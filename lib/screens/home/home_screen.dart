...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> generateRecommendations() async {
    ...
    try {
      final result = await GeminiService.generateTravelRecommendations(_cityController.text);
      ...
      setState(() {
        recommendations = (result['recommended_places'] as List).map((place)=>{
          'name': place['name'] ?? 'tidak ada nama',
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Text(
                'Masukan nama kota dan dapatkan rekomendasi wisata dari kota tersebut!',
